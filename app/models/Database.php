 ...
 *
 * @method int count ()
 * @method Database ArrayBuilder()
 * @method Database JsonBuilder()
 * @method Database ObjectBuilder()
 ...
 * @method Database query ($query, $numRows)
 * @method Database rawQuery ($query, $bindParams, $sanitize)
 * @method Database join (string $objectName, string $key, string $joinType, string $primaryKey)
 * @method Database with (string $objectName)
 * @method Database groupBy (string $groupByField)
 * @method Database orderBy ($orderByField, $orderbyDirection, $customFields)
 * @method Database where ($whereProp, $whereValue, $operator)
 * @method Database orWhere ($whereProp, $whereValue, $operator)
 * @method Database setQueryOption ($options)
 * @method Database setTrace ($enabled, $stripPrefix)
 * @method Database withTotalCount ()
 * @method Database startTransaction ()
 * @method Database commit ()
 * @method Database rollback ()
 * @method Database ping ()
...
class Database {
    ...
    public function __get ($name) {
        if (isset ($this->data[$name]) && $this->data[$name] instanceof Database)
    ...
    /**
     * Helper function to create Database with Json return type
     *
     * @return Database
     */
    ...
    /**
     * Helper function to create Database with Array return type
     *
     * @return Database
     */
    ...
    /**
     * Helper function to create Database with Object return type.
    ...
    public static function table ($tableName) {
        ...
        if (!class_exists ($tableName))
            eval ("class $tableName extends Database {}");
     ...
     *
     * Transparently creating Database class to provide smooth API like name::get() name::orderBy()->get()
     *
     * @param string $method
     * @param mixed $arg
     *
    ...
    private function prepareData () {
        ...
        foreach ($this->data as $key => &$value) {
            if ($value instanceof Database && $value->isNew == true) {
                $id = $value->save();
                if ($id)
                    $value = $id;
                else
    ...
    private static function DatabaseAutoload ($classname) {
     ...
     *
     * Calling autoload() without path will set path to DatabasePath/models/ directory
     *
     * @param string $path
     */
    public static function autoload ($path = null) {
        ...
        spl_autoload_register ("Database::DatabaseAutoload");
    }
}
